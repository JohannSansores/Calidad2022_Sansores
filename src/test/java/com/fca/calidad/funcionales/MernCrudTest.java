...
public class MernCrudTest {
  ...
  public void BtestEditar() throws Exception {
	driver.get("https://mern-crud.herokuapp.com/");
	driver.findElement(By.xpath("//*[@id=\"root\"]/div/div[2]/table/tbody/tr/td[5]/button[1]")).click();
	pause(5000);
	driver.findElement(By.name("name")).click();
	driver.findElement(By.name("name")).clear();
  ...
  //Test para editar un usuario ES IMPORTANTE CREARLO ANTES
  @Test
  public void CtestEliminar() throws Exception {
    driver.get("https://mern-crud.herokuapp.com/");
    driver.findElement(By.xpath("//*[@id=\"root\"]/div/div[2]/table/tbody/tr[1]/td[5]/button[2]")).click();
